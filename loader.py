...
def get_dataset():
    ...
    my_test_texts = []
    my_test_texts.append("this movie is very good and interesting")
    my_test_texts.append("this movie is not good at all")
    my_test_texts.append("this movie is bad and horrible")
    my_test_texts.append("the movie was mostly good but the end was disappointing")
    my_test_texts.append("the movie was funny sometimes but for the most time i was bored")
